...
=== Technologie Stack
****
Die folgenden Technologien und Libraries werden für das Projekt empfohlen und werden von uns übernommen
...
.Libraries +
* Pi4J (Java API für Raspberry Pi)
* JUnit (Test-Framework)
* JavaFX (Java Grafiklibrary)
****
