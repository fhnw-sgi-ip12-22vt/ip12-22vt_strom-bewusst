...
public class StromBewusstFactory implements EntityFactory {
    ...
    public Entity newOutside(SpawnData data) {
        ...
        return entityBuilder(data)
                ...
                .bbox(new HitBox(new Point2D(FXGL.getAppWidth() - 210, 0), BoundingShape.box(0, FXGL.getAppHeight()))) //rand rechts
                .bbox(new HitBox(new Point2D(0, FXGL.getAppHeight() - 20), BoundingShape.box(FXGL.getAppWidth(), 0)))// rand unten
                ...
                .bbox(new HitBox(new Point2D(660,490), BoundingShape.box(695, FXGL.getAppHeight()-490)))
