...
public class TeamName {
    private final List<String> nameCandidatesFirst = FXGL.getAssetLoader().loadText("team_names_first.txt");
    private final List<String> nameCandidatesSecond = FXGL.getAssetLoader().loadText("team_names_second.txt");
