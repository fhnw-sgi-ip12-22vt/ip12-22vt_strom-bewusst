== TC3.1 : https://www.cs.technik.fhnw.ch/confluence20/display/VT122202/Requirements#Requirements-F003R01[F003R01] : Benutzer/in  kann sich horizontal und vertikal bewegen mit dem Joystick ==
